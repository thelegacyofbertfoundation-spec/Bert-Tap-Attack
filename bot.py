...
def get_leaderboard_text():
    try:
        ...
        if not players: return "🏆 Leaderboard 🏆\n\nNo scores yet! (Scores reset on Bot restart)."
        ...
        return "⚠️ Leaderboard is currently unavailable."
